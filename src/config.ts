...
export const themeConfig: ThemeConfig = {
  ...
  seo: {
    ...
    verification: {
      ...
      google: 'pFgVNr3EqDAe-9quN7tCVG0h2nYjyKU3D7p-4_o2',
      // bing webmaster tools
      // https://www.bing.com/webmasters
      bing: '9A99F175437938952F36360FD2AA5C82',
      // yandex webmaster
      // https://webmaster.yandex.com
      yandex: '1808d186d7523334',
      // baidu search
    ...
    googleAnalyticsID: 'G-1JS8ME9PMM',
    // umami analytics
    // https://cloud.umami.is
    umamiAnalyticsID: 'f3521695-20dc-49f9-b921-c425dd9aa26d',
    // follow verification
    // https://follow.is/
    follow: {
      // feed ID
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/ianho7',
      },
      {
        name: 'Email',
        url: 'heguanjie123@gmail.com',
      },
      {
        name: 'X',
        url: 'https://x.com/yehuo0v0',
      },
    ],
